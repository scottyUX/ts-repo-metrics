...
// SIP-2.3.1 (temporary): empty-state subtitles when token cards were always shown.
    ...
    <div className="space-y-8">
      ...
      {!data ? (
        ...
        <>
            ...
            <section className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <MetricCard
                  ...
                  sub="Prompt and context tokens sent to the model."
                  helpId="input-tokens"
                  mono
                />
                <MetricCard
                  ...
                  sub="Response tokens generated by the model."
                ...
                <MetricCard
                  ...
                  sub="Higher is usually faster and cheaper."
                ...
                <MetricCard
                  ...
                  sub="Average total tokens consumed per prompt."
          ...
          {/* SIP-2.3.1 (temporary): prior always-visible section with empty-state cards.
          <section className="space-y-4">
            <h2 className="text-lg font-semibold">Token efficiency</h2>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <MetricCard
