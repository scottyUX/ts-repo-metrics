...
|---|---|---|---|---|---|---|---|
| `conventions.ts:1 h1_else` | 3 ⚠ | 2 | 1 ⚠ | 2 | 30.881 | 25.3 | else_clauses=1 |
...
| `conventions.ts:14 h3_switchBreaks` | 4 | 4 | 4 ⚠ | 1 | 82.418 | 101.6 | nonempty_case_clauses=3, unlabeled_jumps=3, switch_statements=1 |
| `conventions.ts:23 h4_logicalOps` | 4 | 4 | 1 ⚠ | 2 | 42 | 30 | logical_sequences=1 |
| `conventions.ts:27 h5_nestedFn` | 2 ⚠ | 1 | 1 ⚠ | 0 | 47.549 | 24 | nested_fn_expr=1 |
| `conventions.ts:28 inner` | _absent_ | 2 | _absent_ | 1 | _absent_ | 20.7 | — |
| `conventions.ts:33 h6_plain` | 1 | 1 | 0 | 0 | 33 | 53.2 | — |
| `else_chains.ts:1 elseIfChain` | 9 ⚠ | 5 | 10 ⚠ | 5 | 89.835 | 99.7 | else_clauses=4 |
| `else_chains.ts:8 plainElse` | 3 ⚠ | 2 | 1 ⚠ | 2 | 30.881 | 25.3 | else_clauses=1 |
